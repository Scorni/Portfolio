    ...
    <main>
      <section className="professionnal">
        ...
        <div className="stage">
          <Trans i18nKey="stage">
            <h3>
              Bachelor Computer Sciences at Ephec.
              <br />
              From 2017 to 2021
            </h3>
            <p>
              Stage at IT-School as fullstack php developper under symfony.
              <br />
        ...
        <div className="wecodx">
          <Trans i18nKey="wecodx">
            <h3>
              Student fullstack developper at Wecodx.
              <br />
              August 2021
            </h3>
            <p>
        ...
        <div className="uliege">
          <Trans i18nKey="uliege">
            <h3>
              Master artificial intelligence at University of Liège.
              <br />
              Septembre 2021 - February 2022
            </h3>
            <p>Was the wrong way choosen !</p>
          </Trans>
        </div>
        <div className="selfFormation">
          <Trans i18nKey="selfFormation">
            <h3>
              Formation sur divers aspects de la programmation.
              <br />
              Juin 2022 - Now
            </h3>
            <p>
              Learning a lot about front-end technologie such as react, sass,
              animations.
            </p>
          </Trans>
        </div>
        <div className="wecodx2">
          <Trans i18nKey="wecodx2">
            <h3>
              Développeur fullstack Symfony at WeCodx
              <br />
              Avril 2023 - Octobre 2023
            </h3>
            <p>
              Developping with PHP under symfony environment. <br />
              Frontend was held by classic Javascript | Twig. <br />
              Upgrading and adding features to their construction site
        ...
        <div className="addf">
          <Trans i18nKey="addf">
            <h3>
              Développeur fullstack Laravel at ADDF
              <br />
              October 2023 - February 2025
            </h3>
            <p>
              Developping with PHP under Laravel environment. <br />
              Frontend was held with Vuejs. <br />
              Upgrading and adding features to their Funeral management's
            </p>
          </Trans>
        </div>
      </section>
      <section className="personnal">
        ...
        <div className="description">
          <Trans i18nKey="secondDescription">
            <h3>Currently learning UX | UI and Web Design</h3>
            <p>
        ...
        <div>
          <div className="sideProject">
            <div className="firstRow">
              ...
              {/* <<<<<<<              <div className="weather">
                <a
                  href="https://esports-stats.up.railway.app"
                  target={"_blank"}
                  rel="noreferrer"
                >
                  <img
            ...
            <div className="firstRow">
              <div className="quizz">
                <a
                  href="https://scorni-usbe-aters-quizz.vercel.app"
                  target={"_blank"}
                  rel="noreferrer"
                >
                  <img
                  ...
                  ></img>
                  <Trans i18nKey="quizz">
                    <h4>Nerd quizz game</h4>

                    <p className="date">03/06/2022</p>
                  </Trans>
                </a>
              </div>
            </div>
